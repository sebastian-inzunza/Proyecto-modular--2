...
const App = () => {
  ...
  const showModal = (evento, equipo, momio, enemigo) => {
    setEquipo(equipo)
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex justify-center m-0">
          <button onClick={() => showModal(record, record.nombreLocal, record.oddsLocalTeam, record.nombreVisitante  )} className="bg-gray-200 px-20 py-2 rounded-md transform transition-transform duration-300 hover:bg-green-500 hover:text-white ease-in-out hover:-translate-y-1 hover:shadow-md ">
            <div className="block font-semibold">
    ...
    },
    {
      ...
      render: (text, record) => (
        ...
        <div className="flex justify-center m-0">
          <button onClick={() => showModal(record,"Empate" ,record.oddsDraw)} className="bg-gray-200 px-20 py-2 rounded-md transform transition-transform duration-300 hover:bg-green-500 hover:text-white ease-in-out hover:-translate-y-1 hover:shadow-md ">
            <div className="block font-semibold">
              <span className="text-base">Empate</span>
              <br />
    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="flex justify-center m-0">
          <button onClick={() => showModal(record,record.nombreVisitante, record.oddsVisitTeam, record.nombreLocal)} className="bg-gray-200 px-20 py-2 rounded-md transform transition-transform duration-300 hover:bg-green-500 hover:text-white ease-in-out hover:-translate-y-1 hover:shadow-md ">
            <div className="block font-semibold">
  ...
  const columnnMobile = [
  {
    ...
    render: (text, record) =>(
      <div>
              ...
              <div className="border border-stone-500 mt-2"></div>
              <div className="flex justify-center mt-4">
                <button onClick={() => showModal(record, record.nombreLocal, record.oddsLocalTeam, record.nombreVisitante  )}  className="bg-gray-200 w-full py-1 rounded-md transform transition-transform duration-300 hover:bg-green-500 hover:text-white ease-in-out hover:-translate-y-1 hover:shadow-md ">
                  <div className="block font-semibold">
              ...
              <div className="flex justify-center mt-4">
                <button  onClick={() => showModal(record,"Empate" ,record.oddsDraw)} className="bg-gray-200 w-full py-1 rounded-md transform transition-transform duration-300 hover:bg-green-500 hover:text-white ease-in-out hover:-translate-y-1 hover:shadow-md ">
                  <div className="block font-semibold">
                    <span className="text-sm">Empate</span>
                    <br />
              ...
              <div className="flex justify-center mt-4">
                <button  onClick={() => showModal(record,record.nombreVisitante, record.oddsVisitTeam, record.nombreLocal)}  className="bg-gray-200 w-full py-1 rounded-md transform transition-transform duration-300 hover:bg-green-500 hover:text-white ease-in-out hover:-translate-y-1 hover:shadow-md ">
                  <div className="block font-semibold">
  ...
  return (
        <>
          ...
          <ModalComponent visible={visible} onCancel={closeModal} evento={selectedEvento} equipoSeleccionado={equipo} momio={momio} nombreEvento={nombre} equipoEnemigo={enemigo}/>
